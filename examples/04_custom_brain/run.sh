...
../../crom train --input corpus_texto --output brain_texto.cromdb

echo "[*] Vamos tentar comprimir o texto..."
../../crom pack --input corpus_texto/poesia.txt --codebook brain_texto.cromdb --output poesia.crom
...
../../crom pack --input imagem.bin --codebook brain_texto.cromdb --output imagem.crom 2>/dev/null || echo "Ocorreu warning ou miss"
