...
|---|---|---|---|---|---|
| logs_200k.json (24.98 MB) | 26200000 bytes | 165426 (99.00%) | 2462 (99.00%) | 4940072 (81.00%) | 4940142 (81.00%) |
| dump_v1.sql (5.46 MB) | 5727877 bytes | 270566 (95.00%) | 90729 (98.00%) | 1345533 (76.00%) | 1344345 (76.00%) |

## Tempos de Execução (Segundos)
| File | Gzip -9 | Zstd -19 | Crompressor Single | Crompressor Multi |
|---|---|---|---|---|
| logs_200k.json | s | s | 9.33s | 10.92s |
| dump_v1.sql | s | s | 2.56s | 3.03s |
