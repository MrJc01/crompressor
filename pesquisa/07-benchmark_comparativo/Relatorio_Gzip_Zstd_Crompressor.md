...
|---|---|---|---|---|---|
| logs_200k.json (24.98 MB) | 26200000 bytes | 165426 (99.00%) | 2462 (99.00%) | 5144296 (80.00%) | 5144395 (80.00%) |
| dump_v1.sql (5.46 MB) | 5727877 bytes | 270566 (95.00%) | 90729 (98.00%) | 1386219 (75.00%) | 1386279 (75.00%) |

## Tempos de Execução (Segundos)
| File | Gzip -9 | Zstd -19 | Crompressor Single | Crompressor Multi |
|---|---|---|---|---|
| logs_200k.json | s | s | 5.08s | 4.45s |
| dump_v1.sql | s | s | 2.01s | 2.91s |
